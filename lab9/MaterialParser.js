...
/*
	console.log("=====================================");
	console.log("Materials = " + mtl.materials.length);
	
	for(i = 0 ; i < mtl.materials.length ; i++) {
		console.log("	* name = " + mtl.materials[i].name);
		console.log("	* Ka = (" 	+ mtl.materials[i].Ka.r + " "
								+ mtl.materials[i].Ka.g + " "
								+ mtl.materials[i].Ka.b + " "
								+ mtl.materials[i].Ka.a + ")");
		console.log("	* Kd = (" 	+ mtl.materials[i].Kd.r + " "
								+ mtl.materials[i].Kd.g + " "
								+ mtl.materials[i].Kd.b + " "
								+ mtl.materials[i].Kd.a + ")");
		console.log("	* Ks = (" 	+ mtl.materials[i].Ks.r + " "
								+ mtl.materials[i].Ks.g + " "
								+ mtl.materials[i].Ks.b + " "
								+ mtl.materials[i].Ks.a + ")");
		console.log("	* Ns = " + mtl.materials[i].Ns);
		console.log("	* map_Kd = " + mtl.materials[i].mapKd);
		}
*/
	return mtl;
}
